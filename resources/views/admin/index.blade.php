        ...
        <div class="row">
            ...
            <div class="col-sm-2 sidenav">
                ...
                <div class="list-group">
                    ...
                    <a href="{{route('order.index')}}" class="list-group-item {{Route::currentRouteName() == 'order.index' || Route::currentRouteName() == 'order.show' ? 'active' : ''}}">Đơn Hàng</a>

                    <a href="{{route('getLogout')}}" class="list-group-item" style="margin-top: 30vh"><i class="fa fa-arrow-left"></i> Đăng xuất</a>
